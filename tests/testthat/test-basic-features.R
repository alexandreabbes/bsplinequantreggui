# tests/testthat/test-basic-features.R
# Tests spécifiques basic

test_that("Basic app (app1) works with BsplineQuantReg >= 0.2.2", {
  skip_if_not_installed("BsplineQuantReg")
  skip_if(packageVersion("BsplineQuantReg") < "0.2.2")


  # tests/run_all_tests.R
  # Run this from the package root directory

  run_all_tests_basic <- function() {
    cat("\n")
    cat("╔══════════════════════════════════════════════════════════════╗\n")
    cat("║     BsplineQuantReg GUI BASIC test suite            ║\n")
    cat("╚══════════════════════════════════════════════════════════════╝\n")
    cat("\n")
    ...
    for (file in test_files) {
      file_path <- file.path("tests/testthat/basic", file)
